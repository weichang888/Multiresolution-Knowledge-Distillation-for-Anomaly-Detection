...
import os
os.chdir(r"D:\7112095021chengwei\Anomaly detection\Knowledge_Distillation_AD-main")

def get_config(config_file):
    with open(config_file, 'r') as stream:
        return yaml.load(stream, Loader=yaml.SafeLoader)
    
config = get_config(r'D:\7112095021chengwei\Anomaly detection\Knowledge_Distillation_AD-main\configs\config.yaml')
